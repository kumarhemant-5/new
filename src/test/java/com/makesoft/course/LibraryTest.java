...
class LibraryTest {
    ...
    public void testGetQuery1(){
        if(testCheck() && testCheck1()){
            String actual =
                lib.getQuery("125,C programming,Brian W. Kernighan|564,C++ programming,Bjarne Stroustrup|546,Java programming,James Gosling|897,Data Structure,Adam Drozdek|785,System Programming,Johnson M|265,Data Structure,Adam Drozdek|469,Data Structure,Adam Drozdek|968,Advanced Java,James Gosling",
                        "125,101|564,102|546,103|897,104|785,101","1,546");
    ...
    public void testGetQuery2(){
        if(testCheck() && testCheck1()){
            String actual=
                    lib.getQuery("1001,Adventures of Sherlock Homes,Sir Arthur Conan Doyle|1002,Adventures of Tom Sawyer,The Mark Twain|1003,Alice in the Wonderland,Lewis Carroll|1004,All's Well that Ends well,William Shakespeare|1005,As you like it,William Shakespeare|1006,Anand Math,Bankim Chandra chatterjee",
                            "1006,101|1003,102|1001,101","1,1005");
    ...
    public void testGetQuery3(){
        if(testCheck() && testCheck1()){
            String actual =
                    lib.getQuery("125,C programming,Brian W. Kernighan|564,C++ programming,Bjarne Stroustrup|546,Java programming,James Gosling|897,Data Structure,Adam Drozdek|785,System Programming,Johnson M|265,Data Structure,Adam Drozdek|469,Data Structure,Adam Drozdek|968,Advanced Java,James Gosling",
                            "125,101|564,102|546,103|897,104|785,101","3,Data Structure");
    ...
    public void testQuery4(){
        if(testCheck() && testCheck1()){
            ...
            String exp="1001 Adventures of Sherlock Homes\n1006 Anand Math\n";
            assertEquals(exp,actual);
        }else{
            assertEquals(0,1);
        }
    ...
    public void testQuery5(){
        if(testCheck() && testCheck1()){
            String actual=
                    lib.getQuery("1001,Adventures of Sherlock Homes,Sir Arthur Conan Doyle|1002,Adventures of Tom Sawyer,The Mark Twain|1003,Alice in the Wonderland,Lewis Carroll|1004,All's Well that Ends well,William Shakespeare|1005,As you like it,William Shakespeare|1006,Anand Math,Bankim Chandra chatterjee",
                            "1006,101|1003,102|1001,101","4,William Shakespeare");
